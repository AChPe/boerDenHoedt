// exports.boerDenHoedtCalcs1 = function boerDenHoedtCalcs1(obj, index, array, seasonStrat,) {
    exports.boerDenHoedtCalcs1 = function boerDenHoedtCalcs1(obj, index, array, winterStrat, summerStrat ) {
    ...
    // console.log('array: ' + JSON.stringify(array));
        ...
        // let targetCondition = (obj.month < 5 || obj.month > 8 ? seasonStrat.filter(f.hourFilter, index);
